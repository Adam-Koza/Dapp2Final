const ary = [
    ...
    },
    {
        ...
        "company": "JASPER",
        "about": "Enim excepteur commodo adipisicing aliquip aute in ipsum dolore qui velit. Adipisicing enim sunt do nostrud. Exercitation occaecat adipisicing qui quis amet ex aliqua consequat. Ut cillum eiusmod sunt irure eu duis do veniam ut irure in adipisicing laboris.",
    ...
    },
    {
        ...
        "company": "PERMADYNE",
        "about": "Proident sit veniam velit eiusmod occaecat et laboris proident ex proident adipisicing eiusmod. Aliqua labore elit laborum excepteur officia voluptate sint in. Ad amet adipisicing reprehenderit eiusmod laborum do ullamco labore proident consectetur qui do quis. Elit minim officia consectetur in nisi labore tempor irure non esse excepteur quis veniam. Ullamco excepteur et tempor aute ad fugiat est tempor.",
    ...
    },
    {
        ...
        "company": "MOTOVATE",
        "about": "Commodo qui exercitation ipsum cupidatat occaecat est cupidatat ex quis proident. Duis enim magna non do nostrud laboris adipisicing quis aute nulla ad magna excepteur reprehenderit. Laborum laboris proident laboris velit laborum ullamco voluptate occaecat. Lorem eiusmod do sit mollit pariatur culpa. Et duis ad amet laborum velit Lorem incididunt sit. Minim in nulla ex et esse est culpa ad proident aute cupidatat laboris. Est voluptate et ullamco tempor et deserunt minim dolore et.",
    ...
    },
    {
        ...
        "company": "FLYBOYZ",
        "about": "Adipisicing nulla ipsum duis culpa Lorem ea exercitation. Consequat sit ea officia labore nisi eiusmod consequat. Ut eiusmod magna aute occaecat deserunt. Cillum deserunt mollit anim in eu occaecat irure anim officia excepteur eu excepteur dolore incididunt.",
    ...
    },
    {
        ...
        "company": "MALATHION",
        "about": "Anim Lorem reprehenderit fugiat irure irure. Eu sunt eiusmod reprehenderit enim anim dolor do esse laboris et adipisicing sint aliquip. Velit esse sunt sunt excepteur occaecat ut ipsum. Duis ullamco elit ea eu anim excepteur anim et sunt duis.",
...
const mapped = filtered.map(item => {
    return { "first": item.name.first, "last": item.name.last, "balance": item.balance };
});

render() {
    return (
        <ul>
            {this.mapped.map((person, i) =>
                <li key={i}>
                    <h1>Name: {person.first} {person.last}</h1>
                    <h2>Balance: {person.balance}</h2>
                </li>)}
        </ul>
    )
}
